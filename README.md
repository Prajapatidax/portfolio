...
![https://drive.google.com/file/d/1N73FvmEQl7T3VKt7Qz_GfJSrJFaOkGOp/view?usp=sharing](https://drive.google.com/file/d/1N73FvmEQl7T3VKt7Qz_GfJSrJFaOkGOp/view?usp=sharing)
## 💡 About The Project
...
### Key Features
* ✨ **Modern UI/UX:** Clean aesthetic with smooth animations.
* 📱 **Fully Responsive:** Optimized for mobile, tablet, and desktop.
* 🌗 **Dark/Light Mode:** System preference detection with manual toggle.
* 🚀 **High Performance:** Optimized for SEO and fast load times.
* 📫 **Contact Integration:** Functional contact form using [EmailJS/Formspree].
